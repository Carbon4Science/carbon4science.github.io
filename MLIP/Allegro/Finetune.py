"""Allegro fine-tuning module.

Uses the same nequip-train CLI as NequIP, with the Allegro-OAM-L checkpoint.
Shares the nequip conda environment.
...
def finetune(train_file, val_file, output_dir, epochs=50, device="cuda"):
    """Fine-tune Allegro-OAM-L on extxyz data using nequip-train CLI.
    ...
    package_path = _find_nequip_package("mir-group/Allegro-OAM-L:0.1")
    ...
    compiled_path = os.path.join(output_dir, "Allegro_finetuned.nequip.pt2")
