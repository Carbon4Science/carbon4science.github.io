#!/usr/bin/env python3
"""eSEN-30m-mp model-specific relaxation (MBD original protocol).

Matbench Discovery uses FIRE + FrechetCellFilter + fmax=0.02 (a bit tighter
than the common 0.05). Results are written to results/specific/eSEN/ so they
...
def main():
    parser = argparse.ArgumentParser(description="eSEN MBD-protocol relaxation")
    parser.add_argument(
        "--config",
