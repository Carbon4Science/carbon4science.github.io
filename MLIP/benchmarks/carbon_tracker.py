...
class CarbonTracker:
    ...
    Args:
        ...
        output_dir: Directory to save results (default: MLIP/results/outputs)
    ...
    def __init__(
        self,
        project_name: str,
        output_dir: str = "MLIP/results/outputs",
        model_name: str = "",
        task: str = "inference",
...
def aggregate_results(results_dir: str = "MLIP/results/outputs") -> List[Dict[str, Any]]:
    """
