...
def plot_fig4():
    ...
    ref_data = [
        ...
        ('AI Synthesis prediction',  'Reaction outcome pred.',   'LlaSMol',            17.7,    'job'),
        ...
        ('AI Chemical generation',   'Material generation',      'MatterGen',         248,     'job'),
        ('Everyday activities',      'Driving a car',            'EU average',         170,     'km'),
        ('AI Synthesis prediction',  'Synthesis Planning',       'RetroBridge',        403,     'job'),
        ('AI Chemical generation',   'Molecule generation',      'DeFoG',              355.2,  'job'),
        ('AI MD simulation',         'MLIP simulation',         'eSEN',              3486,     'job'),
